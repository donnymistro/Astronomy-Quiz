...
public class MainActivity extends AppCompatActivity {
    ...
    private double grade(boolean oneCChecked, boolean twoDChecked,
                         boolean threeAChecked, boolean fourAChecked ,
                         boolean fourBChecked, boolean fourCChecked,
                         boolean fourDChecked ,boolean fiveAChecked,
                         boolean fiveBChecked, boolean fiveCChecked,
                         boolean fiveDChecked, boolean sixAChecked,
                         String sevenCorrect, boolean eightCChecked,
                         boolean nineDChecked, boolean tenAChecked){
        double score = 0;
        if (oneCChecked){
            score = score + 10;
        }
        ...
        if (fourBChecked && fourCChecked && !fourAChecked && !fourDChecked){
            score = score + 10;
        }
        if (fourBChecked && !fourCChecked && !fourAChecked && !fourDChecked){
            score = score + 5;
        ...
        if (!fiveAChecked && fiveBChecked && fiveCChecked && fiveDChecked){
            score = score + 10;
        }
        else if (!fiveAChecked && !fiveBChecked && !fiveCChecked & fiveDChecked){
            score = score + (10.0 / 3);
        }
        else if (!fiveAChecked && !fiveBChecked && fiveCChecked & !fiveDChecked){
            score = score + (10.0 / 3);
    ...
    public void submit(View view){
        ...
        boolean fourAChecked = four_A.isChecked();
        boolean fourBChecked = four_B.isChecked();
        boolean fourCChecked = four_C.isChecked();
        boolean fourDChecked = four_D.isChecked();
        boolean fiveAChecked = five_A.isChecked();
        ...
        double score = grade(oneCChecked, twoDChecked,
                threeAChecked, fourAChecked,
                fourBChecked, fourCChecked,
                fourDChecked, fiveAChecked,
                fiveBChecked, fiveCChecked,
                fiveDChecked, sixAChecked,
                sevenCorrect, eightCChecked,
                nineDChecked, tenAChecked);
        if(score >= 70){
            ...
            Context context = getApplicationContext();
            CharSequence text = "Your score is: " + score + " out of 100!\n";
            text = text + "Sorry, you didn't pass the quiz";
            int duration = Toast.LENGTH_LONG;
